...
const FeaturedJobs = () => {
    ...
    const jobs = [
        ...
        { id: '3', title: 'Apple Developer', company: 'Apple', salary: "$180,00", location: "Accra, Ghana", image: require('../../assets/apple.png') },
        { id: '4', title: 'Senior Developer', company: 'Facebook', salary: "$200,00", location: "Accra, Ghana", image: require('../../assets/facebook.png') },
        { id: '5', title: 'Sales Manager', company: 'Google', salary: "$160,00", location: "Osu, Ghana", image: require('../../assets/google.png') },
        { id: '6', title: 'Junior Executive', company: 'Apple', salary: "$190,00", location: "Accra, Ghana", image: require('../../assets/apple.png') },
